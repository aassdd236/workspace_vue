    ...
    data() {
        return {
            ...
            seats: [
                ...
                { id: "E-1", number: 1, selected: false },
                { id: "E-2", number: 2, selected: false },
                { id: "E-3", number: 3, selected: false },
                { id: "E-4", number: 4, selected: false },
                { id: "E-5", number: 5, selected: false },
                { id: "E-6", number: 6, selected: false },
                { id: "E-7", number: 7, selected: false },
                { id: "E-8", number: 8, selected: false }
            ]
        };
    },
    computed: {
